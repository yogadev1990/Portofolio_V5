...
const WORDS = ["Future Dentist", "Future Bussinessman", "Fullstack Developer", "Tech Enthusiast"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/yogadev1990/" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/randa-yoga-saputra/" },
  { icon: Instagram, link: "https://www.instagram.com/yoga_art1990/" }
];
...
const Home = () => {
  ...
  const lottieOptions = {
    src: "https://lottie.host/29b31553-98c5-475c-9abd-f64a15b72723/z66bHVbSQQ.lottie",
    loop: true,
    autoplay: true,
    rendererSettings: {
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  I'm a passionate Web Developer with a background in Dentistry. I love to create beautiful and functional websites using modern technologies.
                </p>
